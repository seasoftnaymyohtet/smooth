...
<head>
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="../../css/min/edit.min.css">
...
<body>
  ...
  <div class="container">
    ...
    <main>
      <div class="mainInner">
        <form id="edit" class="edit" action="../profile" method="post">
          <div class="edit_box">
            <section class="formarea_box">
              <div class="formarea_box_bighead">
                <span class="formarea_box_bighead text">プロフィール</span>
              </div>
              <div class="inner">
                <!-- <div class="formarea_box_head">
                  <span class="formarea_box_head text">プロフィール<span class="must">※</span></span>
                </div> -->
                <div class="formarea_box_inputarea">
                  <div class="inputline">
                    <div class="inputline_item"><span class="inputline_item text">姓</span><span class="must">※</span></div>
                    <div class="inputline_fill">
                      <input class="inputline_fill in" name="name1" type="text" value="">
                    </div>
                  </div>
                  <div class="inputline">
                    <div class="inputline_item"><span class="inputline_item text">名</span><span class="must">※</span></div>
                    <div class="inputline_fill">
                      <input class="inputline_fill in" name="name2" type="text" value="">
                    </div>
                  </div>
                  <div class="inputline">
                    <div class="inputline_item"><span class="inputline_item text">セイ</span><span class="must">※</span></div>
                    <div class="inputline_fill">
                      <input class="inputline_fill in" name="kana1" type="text" value="">
                    </div>
                  </div>
                  <div class="inputline">
                    <div class="inputline_item"><span class="inputline_item text">メイ</span><span class="must">※</span></div>
                    <div class="inputline_fill">
                      <input class="inputline_fill in" name="kana2" type="text" value="">
                    </div>
                  </div>
                  <div class="inputline">
                  ...
                  <div class="inputline">
                    ...
                    <div class="inputline_choice">
                      <label class="inputline_choice_label" for="pic"><span class="inputline_choice_label dec"></span><input class="inputline_choice_label in" accept="image/jpeg,image/gif,image/jpg,image/png" name="pic" type="file" value="">写真をアップロード</label>
                    </div>
                  </div>
                  <div class="inputline">
                  ...
                  <div class="inputline">
                    <div class="inputline_item"><span class="inputline_item text">メールアドレス</span><span class="must">※</span></div>
                    <div class="inputline_fill">
                      <input class="inputline_fill in" name="email" type="email" value="">
                    </div>
                  </div>
                  <div class="inputline">
            ...
            <section class="formarea_box">
              <div class="formarea_box_bighead">
                <span class="formarea_box_bighead text">最終学歴</span>
              </div>
              <div class="inner">
                <!-- <div class="formarea_box_head">
            ...
            <section class="formarea_box">
              <div class="formarea_box_bighead">
                <span class="formarea_box_bighead text">職務経歴</span>
              </div>
              <div class="inner">
                <div class="formarea_box_head">
                  <span class="formarea_box_head text">職歴1<span class="option">（任意）</span></span>
                </div>
                <div class="formarea_box_inputarea">
                  <div class="inputline">
            ...
            <section class="formarea_box">
              <div class="formarea_box_bighead">
                <span class="formarea_box_bighead text">自己PR</span>
              </div>
              <div class="inner">
                <div class="formarea_box_head">
        ...
        <button form="edit" class="cms_btn" type="submit"><span class="cms_btn action">内容を保存する</span></button>
      </div>
    </main>
    <!--[END] main -->
